...
The TypeScript SDK for the Pokemon3d API. Provides a type-safe, entity-oriented interface with full async/await support.
...
```ts
const client = new Pokemon3dSDK({ apikey: '...' })
