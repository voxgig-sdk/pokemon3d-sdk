...
class Pokemon3dSDK {
  ...
  static test(testoptsarg?: any, sdkoptsarg?: any) {
    ...
    const testsdk = new Pokemon3dSDK(sdkopts)
    testsdk._mode = 'test'
  ...
  tester(testopts?: any, sdkopts?: any) {
    return Pokemon3dSDK.test(testopts, sdkopts)
  }


  toJSON() {
    return { name: 'Pokemon3d' }
  }

  toString() {
    return 'Pokemon3d ' + this._utility.struct.jsonify(this.toJSON())
  }
