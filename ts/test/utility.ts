...
function envOverride(m: Record<string, any>) {
  if (
    'TRUE' === process.env.POKEMON3D_TEST_LIVE ||
    'TRUE' === process.env.POKEMON3D_TEST_OVERRIDE
  ) {
  ...
  m.POKEMON3D_TEST_EXPLAIN = process.env.POKEMON3D_TEST_EXPLAIN || m.POKEMON3D_TEST_EXPLAIN
