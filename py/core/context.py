...
class Pokemon3dContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(sp, Pokemon3dSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, Pokemon3dResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, Pokemon3dResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return Pokemon3dError(code, msg, self)
