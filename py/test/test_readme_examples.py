# Pokemon3d SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions Pokemon3dSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both Pokemon3dSDK(...) and Pokemon3dSDK.test(...) become
#      Pokemon3dSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "pokemon3d_sdk"
_SDK_CLASS = "Pokemon3dSDK"
