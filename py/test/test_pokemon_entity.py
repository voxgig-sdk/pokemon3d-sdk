...
class TestPokemonEntity:
    ...
    def test_should_stream(self):
        ...
        base = Pokemon3dSDK.test(seed, None)
    ...
    def test_should_run_basic_flow(self):
        ...
        if setup.get("synthetic_only"):
            pytest.skip("live entity test uses synthetic IDs from fixture — "
                        "set POKEMON_D_TEST_POKEMON_ENTID JSON to run live")
        client = setup["client"]
...
def _pokemon_basic_setup(extra):
    ...
    idmap_resolved = helpers.to_map(
        env.get("POKEMON_D_TEST_POKEMON_ENTID"))
    ...
    if env.get("POKEMON_D_TEST_LIVE") == "TRUE":
        ...
        client = Pokemon3dSDK(helpers.to_map(merged_opts))

    _live = env.get("POKEMON_D_TEST_LIVE") == "TRUE"
    return {
        "client": client,
        "data": entity_data,
        "idmap": idmap_resolved,
        "env": env,
        "explain": env.get("POKEMON_D_TEST_EXPLAIN") == "TRUE",
        "live": _live,
