...
class Pokemon3dTimeoutFeature extends Pokemon3dBaseFeature
{
    ...
    private function _with_timeout(Pokemon3dContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(Pokemon3dContext $_ctx, float $ms): void
    {
        $client = $this->client;
