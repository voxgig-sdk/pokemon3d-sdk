...
class Pokemon3dCacheFeature extends Pokemon3dBaseFeature
{
    ...
    private function _through(Pokemon3dContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
