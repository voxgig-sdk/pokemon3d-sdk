...
// Pokemon3d SDK streaming feature
...
class Pokemon3dStreamingFeature extends Pokemon3dBaseFeature
{
    ...
    private function _iterate(Pokemon3dResult $result): \Generator
    {
    ...
    private function _streamable(Pokemon3dContext $ctx): bool
    {
