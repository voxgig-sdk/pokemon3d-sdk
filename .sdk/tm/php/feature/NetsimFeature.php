...
class Pokemon3dNetsimFeature extends Pokemon3dBaseFeature
{
    ...
    private function _simulate(Pokemon3dContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(Pokemon3dContext $ctx, array $applied): void
    {
        $client = $this->client;
