...
// Pokemon3d SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (Pokemon3dSDK::test)
...
{
    private const SDK_CLASS = 'Pokemon3dSDK';
    ...
    private const SDK_BASE = 'pokemon3d_sdk';
