...
{
    private static function utility(): Pokemon3dUtility
    {
        return new Pokemon3dUtility();
    }
    ...
    private static function ctx(array $over = []): Pokemon3dContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new Pokemon3dContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new Pokemon3dOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof Pokemon3dError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new Pokemon3dOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = Pokemon3dMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new Pokemon3dOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = Pokemon3dMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new Pokemon3dOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = Pokemon3dMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new Pokemon3dSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = Pokemon3dMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new Pokemon3dResponse([]),
            'result' => new Pokemon3dResult([]),
        ]);
        [, $err] = Pokemon3dMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new Pokemon3dSpec([]),
            'response' => null,
            'result' => new Pokemon3dResult([]),
        ]);
        [, $err] = Pokemon3dMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new Pokemon3dSpec(['step' => 's']),
            'response' => new Pokemon3dResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new Pokemon3dResult([]),
        ]);
        [, $err] = Pokemon3dMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new Pokemon3dSpec(['step' => 's']),
            'response' => new Pokemon3dResponse(self::resp(200, ['v' => 1])),
            'result' => new Pokemon3dResult([]),
        ]);
        [, $err] = Pokemon3dMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new Pokemon3dSpec(['step' => 's']),
            'response' => new Pokemon3dResponse(self::resp(200, ['v' => 2])),
            'result' => new Pokemon3dResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        Pokemon3dMakeResponse::call($ctx);
    ...
    {
        $preset = new Pokemon3dResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new Pokemon3dSpec([]),
            'response' => new Pokemon3dResponse([]),
            'result' => new Pokemon3dResult([]),
        ...
        [$got, $err] = Pokemon3dMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new Pokemon3dResult([])]);
        [, $err] = Pokemon3dMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new Pokemon3dSpec([]), 'result' => null]);
        [, $err] = Pokemon3dMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new Pokemon3dSpec(['step' => 's']),
            'result' => new Pokemon3dResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new Pokemon3dOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = Pokemon3dMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new Pokemon3dSpec(['step' => 's']),
            'result' => new Pokemon3dResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new Pokemon3dOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = Pokemon3dMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new Pokemon3dResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new Pokemon3dSpec([]),
            'result' => new Pokemon3dResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = Pokemon3dMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = Pokemon3dMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new Pokemon3dError('boom', 'boom');
        $utility->fetcher = function (Pokemon3dContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new Pokemon3dSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = Pokemon3dMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (Pokemon3dContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = Pokemon3dMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(Pokemon3dResponse::class, $response);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (Pokemon3dContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new Pokemon3dSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = Pokemon3dMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new Pokemon3dResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new Pokemon3dSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = Pokemon3dMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = Pokemon3dMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = Pokemon3dMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new Pokemon3dResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, Pokemon3dDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new Pokemon3dResult(['ok' => false])]);
        $this->expectException(Pokemon3dError::class);
        Pokemon3dDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new Pokemon3dResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', Pokemon3dMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        Pokemon3dMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new Pokemon3dBaseFeature();
        $b = new Pokemon3dBaseFeature();
        Pokemon3dFeatureAdd::call($ctx, $a);
        Pokemon3dFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): Pokemon3dBaseFeature
    {
        $f = new Pokemon3dBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        Pokemon3dFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): Pokemon3dContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new Pokemon3dSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = Pokemon3dPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new Pokemon3dResponse(['headers' => null]),
            'result' => new Pokemon3dResult([]),
        ]);
        Pokemon3dResultHeaders::call($ctx);
