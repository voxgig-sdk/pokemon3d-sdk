...
class Pokemon3dTestRunner
{
    ...
    {
        $live = self::getenv('POKEMON3D_TEST_LIVE');
        $override = self::getenv('POKEMON3D_TEST_OVERRIDE');
        ...
        $explain = self::getenv('POKEMON3D_TEST_EXPLAIN');
...
class_alias('Pokemon3dTestRunner', 'Runner');
class_alias('Pokemon3dHelpers', 'Helpers');
