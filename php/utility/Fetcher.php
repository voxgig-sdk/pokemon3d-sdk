...
// Pokemon3d SDK utility: fetcher

class Pokemon3dFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; Pokemon3dSDK/1.0)';
    ...
    public static function call(Pokemon3dContext $ctx, string $fullurl, array $fetchdef): array
    {
