...
// Pokemon3d SDK utility: param

require_once __DIR__ . '/../core/Helpers.php';

class Pokemon3dParam
{
    public static function call(Pokemon3dContext $ctx, mixed $paramdef): mixed
    {
        $point = $ctx->point;
        $spec = $ctx->spec;
        $match_val = $ctx->match;
        ...
        $akey = '';
        if ($point) {
            $alias_map = Pokemon3dHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'alias'));
            if ($alias_map) {
