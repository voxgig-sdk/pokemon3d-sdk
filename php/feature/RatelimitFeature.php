...
// Pokemon3d SDK ratelimit feature
...
class Pokemon3dRatelimitFeature extends Pokemon3dBaseFeature
{
    ...
    private function _acquire(Pokemon3dContext $ctx): void
    {
    ...
    private function _track(Pokemon3dContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
