...
// Pokemon3d SDK clienttrack feature
...
class Pokemon3dClienttrackFeature extends Pokemon3dBaseFeature
{
    ...
    public function PostConstruct(Pokemon3dContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'Pokemon3d-SDK';
