...
class Pokemon3dRbacFeature extends Pokemon3dBaseFeature
{
    ...
    private function _required(Pokemon3dContext $ctx): ?string
    {
    ...
    private function _reject(Pokemon3dContext $ctx, string $required): void
    {
    ...
    private function _track(Pokemon3dContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
