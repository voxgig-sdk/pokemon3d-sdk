...
// Pokemon3d SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class Pokemon3dTestFeature extends Pokemon3dBaseFeature
{
    ...
    public function init(Pokemon3dContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (Pokemon3dContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = Pokemon3dParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (Pokemon3dContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(Pokemon3dContext $ctx, $op, $args): array
    {
