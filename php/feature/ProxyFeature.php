...
class Pokemon3dProxyFeature extends Pokemon3dBaseFeature
{
    ...
    public function init(Pokemon3dContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (Pokemon3dContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
