# Pokemon3d Golang SDK Reference

Complete API reference for the Pokemon3d Golang SDK.
...
#### `TestSDK(testopts, sdkopts map[string]any) *Pokemon3dSDK`
...
#### `Pokemon(data map[string]any) Pokemon3dEntity`
