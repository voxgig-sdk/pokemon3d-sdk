...
The Ruby SDK for the Pokemon3d API — an entity-oriented client using idiomatic Ruby conventions.
...
raise a `Pokemon3dError` (a `StandardError` subclass), so wrap
...
```
rb/
├── Pokemon3d_sdk.rb       -- Main SDK module
