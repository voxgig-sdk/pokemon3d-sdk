...
module Pokemon3dTestRunner
  ...
  def self.env_override(m)
    live = getenv("POKEMON3D_TEST_LIVE")
    override = getenv("POKEMON3D_TEST_OVERRIDE")
    ...
    explain = getenv("POKEMON3D_TEST_EXPLAIN")
    m["POKEMON3D_TEST_EXPLAIN"] = explain if explain && !explain.empty?
...
Runner = Pokemon3dTestRunner
Helpers = Pokemon3dHelpers
Vs = VoxgigStruct
