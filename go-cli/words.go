...
func registerSDKWords(r *eng.Registry, client *sdk.Pokemon3dSDK) {
...
func runOp(client *sdk.Pokemon3dSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
