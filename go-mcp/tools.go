...
type Args struct {
	Entity string         `json:"entity" jsonschema:"pokemon"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.Pokemon3dSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "pokemon3d_list",
		Description: "List records from Pokemon3d. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "pokemon3d_load",
		Description: "Load a single record from Pokemon3d. " +
...
func runOp(client *sdk.Pokemon3dSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.Pokemon3dSDK, name string) (sdk.Pokemon3dEntity, error) {
